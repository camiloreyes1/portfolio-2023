...
const Projects = () => {
  ...
  const projPics = [
    ...
    { name: 'Pixels', imageSrc: 'https://res.cloudinary.com/delscyuhi/image/upload/v1695871890/fogck4mpdufbq38dbgcd.png'},
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
      {projPics.map((proj, index) => (
        <div key={index} className={`bg-white shadow-lg rounded-lg p-4 w-3/4 mx-auto ${index % 2 === 0 ? 'md:col-start-1 lg:col-start-1' : 'md:col-start-2 lg:col-start-2'}`}>
